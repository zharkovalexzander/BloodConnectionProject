...
public class MainActivity extends AppCompatActivity {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_STATE_CHANGE:
                    switch (msg.arg1) {
                        case ChatController.STATE_CONNECTED:
                            writeToConsole("Connected to: " + connectingDevice.getName(), MessageType.Connection);
                            break;
                        case ChatController.STATE_CONNECTING:
                            writeToConsole("Connecting...", MessageType.Connection);
                            break;
                        case ChatController.STATE_LISTEN:
                        case ChatController.STATE_NONE:
                            writeToConsole("Not connected", MessageType.Connection);
                            break;
                    }
                    break;
                case MESSAGE_WRITE:
                ...
                case MESSAGE_READ:
                    ...
                    writeToConsole(tMsg.toString(), MessageType.Query);
                    chatAdapter.notifyDataSetChanged();
                    break;
    ...
    private void writeToConsole(String s, MessageType type) {
        String messager = new String(s);
        switch(type) {
            case Connection:
                messager = "<font color='yellow'>> " + messager + "</font><br>";
                break;
            case Error:
                messager = "<font color='red'>> " + messager + "</font><br>";
                break;
            case Query:
                messager = "<font color='#FF4081'>> " + messager + "</font><br>";
                break;
            case Response:
                messager = "<font color='green'>> " + messager + "</font><br>";
                break;
        }
        console.append(Html.fromHtml(messager));
    }
    ...
    private void findViewsByIds() {
        console = (TextView) findViewById(R.id.innerTerminal);
